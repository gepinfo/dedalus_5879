...
{ path : 'hospitalorderlist', loadChildren: () => import('./hospitalorderlist/hospitalorderlist.module').then(m => m.HospitalorderlistModule), canActivate: [AuthGuard] } , 
{ path : 'externalpatientlist', loadChildren: () => import('./externalpatientlist/externalpatientlist.module').then(m => m.ExternalpatientlistModule), canActivate: [AuthGuard] } , 
];
